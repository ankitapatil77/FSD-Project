...
<%
   ...
   pageContext.setAttribute("userid", "Ankita Patil");
   out.println("userId attribute from pageContext: " + pageContext.getAttribute("userid") + "<br>");    
%>
<a href="JspImplicitObject.jsp?office=head_office pune">Show usage of response object</a><br>
<a href="JspImplicitObject.jsp?error=1">Show usage of error  object</a><br>
